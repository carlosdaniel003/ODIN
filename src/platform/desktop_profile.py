...
from src.platform.desktop_camera_service import (
...
class DesktopODINApp(ODINApp):
    """Perfil base do ODIN para Windows/Linux desktop."""

    CAMERA_SERVICE_CLASS = DesktopCameraService
    ...
    def iniciar_tela_ao_vivo(self) -> None:
        ...
        self.camera_estado_anterior = (
            self.CAMERA_SERVICE_CLASS.ESTADO_PARADA
        )
