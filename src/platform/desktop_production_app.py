...
from src.platform.display_f3_power_evidence_compat import (
...
from src.platform.desktop_base_app import (
    DesktopBaseODINApp,
)
...
class DesktopProductionApp(
    ...
    """Composição canônica do ODIN para Windows/Linux desktop."""
