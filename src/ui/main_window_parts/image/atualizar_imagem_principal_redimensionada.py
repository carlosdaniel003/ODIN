...
def atualizar_imagem_principal_redimensionada(self) -> None:
    ...
    # A imagem já está no padrão BGR usado pelo OpenCV.
    # cv2.imencode converte corretamente esse BGR para o PNG.
    sucesso, buffer = cv2.imencode(".png", self.imagem_exibicao)
